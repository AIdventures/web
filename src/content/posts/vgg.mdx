...
<Highlight color="yellow">So what have we gained by using, for instance, a stack of three 3×3 convolutional layers
instead of a single 7×7 layer?</Highlight> First, <Highlight color="green">incorporates three non-linear rectification layers
