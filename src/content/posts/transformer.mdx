...
*Note: For padding tokens the loss is not computed.*
...
But how really works? <u>Its all about the *Query* and *Key* multiplication</u>. Suppose that we have
just our one initial embedding representation. When we perform our *Query* and *Key* multiplication
...
at *Value* matrix multiplication.
