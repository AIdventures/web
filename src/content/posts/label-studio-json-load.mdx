...
![Label Studio login page](./images/label-studio-json-load/ls_setup.png)
...
![Label Studio local storage configuration](./images/label-studio-json-load/ls_connection.png)
...
![Label Studio label interface](./images/label-studio-json-load/ls_label.png)
