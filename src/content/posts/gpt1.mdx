...
GPT model architecture is a multi-layer <Highlight color="brown">causal Transformer Decoder</Highlight>, almost identical to the original [Transformer](./transformer) implementation.  
