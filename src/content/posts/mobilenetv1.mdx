...
The MobileNet model is based on [depthwise separable convolutions](/posts/depthwise_separable_convolutions) which is a form of factorized convolutions which **factorize a standard convolution into a depthwise convolution and a $1\times1$ convolution called a pointwise convolution**.
...
- [Depthwise separable convolution](/posts/depthwise_separable_convolutions)